...
PROJECT_ID = "pesquisaia-454015"  # Use your project ID
...
def ask_gemini(question):
    ...
    **Resposta**:
    ...
    try:
        ...
        answer = response_json.get("answer", "Nenhuma resposta encontrada.")  # Get the "answer" field
    except json.JSONDecodeError:
        answer = "Erro: Não foi possível interpretar a resposta"
...
def main():
    ...
    # Handle POST request when the user submits a question
        ...
        logging.info(question, extra={"labels": {"service": "autoquest-service", "component": "question"}})
        
        # Get the answer from Gemini based on the vector database search
        answer = ask_gemini(question)

    # Log the generated answer
    logging.info(answer, extra={"labels": {"service": "autoquest-service", "component": "answer"}})
